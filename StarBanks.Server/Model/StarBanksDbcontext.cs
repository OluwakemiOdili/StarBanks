...
namespace StarBanks.Server.Model
{
    public class StarBanksDbContext : DbContext
    {
        public StarBanksDbContext(DbContextOptions<StarBanksDbContext> options) : base(options)
        {
        ...
        {
            //inputting initil Data to the Department Table
